package com.marcos.market_catalog.handlers.exception;

import com.marcos.market_catalog.exceptions.ExceptionMessage;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    private ResponseEntity<ExceptionMessage> httpMessageNotReadableException(HttpMessageNotReadableException exception) {
        Map<String, String> errorMap = new HashMap<>();
        ExceptionMessage exceptionMessage = new ExceptionMessage();
        exceptionMessage.setError(errorMap);
